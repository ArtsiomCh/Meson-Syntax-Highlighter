...
class CheckLicense {
   ...
   */
  private static final String PRODUCT_CODE = "PMESONSYNTAX";
  ...
  private static boolean myIsLicensed() {
    ...
    if (!enabled) {
      final String message =
          "Meson Syntax Highlighter plugin License not found. Plugin functionality will be disabled.";
      new Notification(
          "Meson Syntax Highlighter", "Meson Syntax Highlighter", message, NotificationType.WARNING)
          .notify(null);
    }
    return enabled;
  }
